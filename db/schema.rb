...
ActiveRecord::Schema[7.1].define(version: 20_240_306_075_242) do
  ...
  create_table 'trip_returns', force: :cascade do |t|
    t.integer 'trip_id', null: false
    t.datetime 'return_time', null: false
    t.text 'return_details'
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['trip_id'], name: 'index_trip_returns_on_trip_id'
  end
  ...
  add_foreign_key 'trip_returns', 'trips', on_delete: :cascade
